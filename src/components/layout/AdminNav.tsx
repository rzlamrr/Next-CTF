      ...
      >
        <div className="h-full flex flex-col">
          <div className="px-4 py-6 border-b border-border">
            <div className="text-lg font-bold text-gray-900 dark:text-white">Admin Panel</div>
          ...
          <div className="px-4 py-4 border-t border-border">
            <Link
              href="/"
              className="block text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
            >
              ← Back to Site
            </Link>
          </div>
